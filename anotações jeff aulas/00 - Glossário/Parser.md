...
Eles são usados por exemplo para transformar linguagem de código em linguagem de maquina para que o computador possa executar, ou pra transformar o código de HTML no DOM que fica na página renderizada da web ou pro sistema ler os dados de um arquivo XML ou [[JSON]] 
